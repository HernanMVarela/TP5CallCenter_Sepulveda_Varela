                ...
                while (Datos.Lector.Read())
                {
                    ...
                    if (!(Datos.Lector["NUMID"] is DBNull))
                    {
                        ...
                        if (!(Datos.Lector["TENombre"] is DBNull))
                        {
                            ...
                            Aux.PTecnico.NombreCompleto = (string)Datos.Lector["TENombre"] + " " + (string)Datos.Lector["TEApellido"];
